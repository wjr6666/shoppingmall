...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core"  prefix="c"%>
	...
	<div style="max-width: 1200px; margin: 0 auto;">
		...
		<div id="myModalSign" class="modal hide fade"
			style="background: WhiteSmoke; text-align: left; padding: 10px; font-size: 16px;"
			tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="signForm" name="signForm" 
					action="${path}/sign.do" method="post">
					
					<div class="control-group">
						<label class="control-label" for="Scard_num">账号</label>
						<div class="controls">
							<input type="text" name="userName" id="Scard_num"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required"><span id="Lcn">请输入账号！</span>
							<!-- chrom ie11 input bug 5% height fixed it -->
						</div>
					...
					<div class="control-group">
						<label class="control-label" for="Scard_pass">密码</label>
						<div class="controls">
							<input type="password" name="password" id="Scard_pass"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required"><span id="Lcp">请输入密码！</span>
						</div>
					</div>
					...
					<div class="control-group">
						<label class="control-label" for="Scard_grade">年级</label>
						<div class="controls">
							<select name="grade" id="Scard_grade"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required">
							</select>
								<span id="Lcd">请选择年级！</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="Scard_name">姓名</label>
						<div class="controls">
							<input type="text" name="name" id="Scard_name"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required"><span id="Lcp">请输入姓名！</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="Scard_telphone">电话</label>
						<div class="controls">
							<input type="text" name="telPhone" id="Scard_telphone"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required"><span id="Lcp">请输入电话！</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="Scard_email">邮箱</label>
						<div class="controls">
							<input type="text" name="email" id="Scard_email"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required"><span id="Lcp">请输入邮箱！</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="Scard_qq">QQ</label>
						<div class="controls">
							<input type="text" name="qq" id="Scard_qq"
								style="height: 5%; margin-top: 3px; margin-right: 3px;"
								required="required"><span id="Lcp">请输入QQ！</span>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<input type="submit" name="sign" id="SignSub" value="注册"
								class="btn btn-danger btn-block" style="margin-left: -90px; height: 30px; *background: #f2000d;">
						</div>
					</div>
		...
		<div id="searchdiv" style="width: 100%; height: 30px;">
			...
			<form name="searchForm" action="${path}/search-list.html" method="get"
				...
				<c:if test="${empty user}">
				<a href="${path}/index.html#myModalLogin" id="loginClick" role="button"
						class="btn btn-danger" data-toggle="modal" title="立即登录"
						style="_float: right; _margin-top: 20px;" oncontextmenu="return false;" ondragstart="return false;">
						立即登录
					</a>
				<a href="${path}/index.html#myModalSign" id="signClick" role="button"
						class="btn btn-danger" data-toggle="modal" title="立即登录"
						style="_float: right; _margin-top: 20px;" oncontextmenu="return false;" ondragstart="return false;">
						立即注册
					</a>
	...
	<script type="text/javascript">
	    ...
	    function parseGrade(value) {
	    	...
	    	//根据id查找对象，  
	        var obj = document.getElementById("Scard_grade");  
