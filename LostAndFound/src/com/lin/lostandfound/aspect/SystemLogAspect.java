...
import com.lin.lostandfound.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    // Service层切点  
    @Pointcut("@annotation(com.lin.lostandfound.annotation.SystemServiceLog)")  
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Throwable e) {  
        ...
        if (joinPoint.getArgs() != null && joinPoint.getArgs().length > 0) {  
            for (int i = 0; i < joinPoint.getArgs().length; i++) {  
                params += JSONUtil.encode(joinPoint.getArgs()[i]) + ";";  
            }  
        }  
        try {  
              /*========控制台输出=========*/  
